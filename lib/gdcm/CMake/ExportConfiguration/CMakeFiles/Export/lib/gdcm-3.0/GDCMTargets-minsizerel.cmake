...
set_target_properties(gdcmopenjp2 PROPERTIES
  IMPORTED_IMPLIB_MINSIZEREL "${_IMPORT_PREFIX}/lib/gdcmopenjp2.lib"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmopenjp2.dll"
  )
...
set_target_properties(gdcmmd5 PROPERTIES
  IMPORTED_IMPLIB_MINSIZEREL "${_IMPORT_PREFIX}/lib/gdcmmd5.lib"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmmd5.dll"
  )
...
# Import target "gdcmdump" for configuration "MinSizeRel"
set_property(TARGET gdcmdump APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcmdump PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmdump.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS gdcmdump )
list(APPEND _IMPORT_CHECK_FILES_FOR_gdcmdump "${_IMPORT_PREFIX}/bin/gdcmdump.exe" )

# Import target "gdcmdiff" for configuration "MinSizeRel"
set_property(TARGET gdcmdiff APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcmdiff PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmdiff.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS gdcmdiff )
list(APPEND _IMPORT_CHECK_FILES_FOR_gdcmdiff "${_IMPORT_PREFIX}/bin/gdcmdiff.exe" )

# Import target "gdcmraw" for configuration "MinSizeRel"
set_property(TARGET gdcmraw APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcmraw PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmraw.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS gdcmraw )
list(APPEND _IMPORT_CHECK_FILES_FOR_gdcmraw "${_IMPORT_PREFIX}/bin/gdcmraw.exe" )

# Import target "gdcmscanner" for configuration "MinSizeRel"
set_property(TARGET gdcmscanner APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcmscanner PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmscanner.exe"
  )
...
# Import target "gdcmanon" for configuration "MinSizeRel"
set_property(TARGET gdcmanon APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcmanon PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmanon.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS gdcmanon )
list(APPEND _IMPORT_CHECK_FILES_FOR_gdcmanon "${_IMPORT_PREFIX}/bin/gdcmanon.exe" )

# Import target "gdcmgendir" for configuration "MinSizeRel"
set_property(TARGET gdcmgendir APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcmgendir PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmgendir.exe"
  )
...
# Import target "gdcmimg" for configuration "MinSizeRel"
set_property(TARGET gdcmimg APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcmimg PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmimg.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS gdcmimg )
list(APPEND _IMPORT_CHECK_FILES_FOR_gdcmimg "${_IMPORT_PREFIX}/bin/gdcmimg.exe" )

# Import target "gdcmconv" for configuration "MinSizeRel"
set_property(TARGET gdcmconv APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcmconv PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmconv.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS gdcmconv )
list(APPEND _IMPORT_CHECK_FILES_FOR_gdcmconv "${_IMPORT_PREFIX}/bin/gdcmconv.exe" )

# Import target "gdcmtar" for configuration "MinSizeRel"
set_property(TARGET gdcmtar APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcmtar PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmtar.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS gdcmtar )
list(APPEND _IMPORT_CHECK_FILES_FOR_gdcmtar "${_IMPORT_PREFIX}/bin/gdcmtar.exe" )

# Import target "gdcminfo" for configuration "MinSizeRel"
set_property(TARGET gdcminfo APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcminfo PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcminfo.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS gdcminfo )
list(APPEND _IMPORT_CHECK_FILES_FOR_gdcminfo "${_IMPORT_PREFIX}/bin/gdcminfo.exe" )

# Import target "gdcmscu" for configuration "MinSizeRel"
set_property(TARGET gdcmscu APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcmscu PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmscu.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS gdcmscu )
list(APPEND _IMPORT_CHECK_FILES_FOR_gdcmscu "${_IMPORT_PREFIX}/bin/gdcmscu.exe" )

# Import target "gdcmxml" for configuration "MinSizeRel"
set_property(TARGET gdcmxml APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcmxml PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmxml.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS gdcmxml )
list(APPEND _IMPORT_CHECK_FILES_FOR_gdcmxml "${_IMPORT_PREFIX}/bin/gdcmxml.exe" )

# Import target "gdcmpap3" for configuration "MinSizeRel"
set_property(TARGET gdcmpap3 APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(gdcmpap3 PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/gdcmpap3.exe"
  )
